...
class PollModal(Modal):
    ...
    def initEmojis(self):
        infile = open('cogs/resources/emojis copy.txt', 'r')
        for line in infile:
            if line != '::':
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        for i in range(len(self.emojiList)):
            print(self.emojiList[i].encode('unicode-escape').decode('ASCII'))
            await sent.add_reaction(self.emojiList[i].encode('unicode-escape').decode('ASCII'))
